      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        {lists.length === 0 ? (
          <div className="rounded-lg border-2 border-dashed border-gray-300 bg-white p-12 text-center">
            ...
            <p className="mt-2 text-gray-500">Create your first list to get started!</p>
            <button
              onClick={() => setShowCreateModal(true)}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
            ...
            <input
              ...
              className="mt-4 w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
              autoFocus
